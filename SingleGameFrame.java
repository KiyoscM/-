...
public class SingleGameFrame extends GameFrame implements ActionListener {
    ...
    private int[][] boardStatus = new int[singleBoardSize][singleBoardSize];
    ...
    public SingleGameFrame(SceneController sceneController) {
    ...
    protected void initSingleGame() {
        ...
        furigana.setActionCommand("answer1");
        ...
        answerButton.setActionCommand("answer1");
    ...
    public void update() {
        for (int i = 0; i < singleBoardSize; i++) {
            for (int j = 0; j < singleBoardSize; j++) {
                if (kanji[i][j].getText().equals("")) {
                    kanjiButton[i][j].setVisible(false);
            ...
            public void actionPerformed(ActionEvent e) {
                if (timeLabel.getText().equals("0:00")) {
					...
					try {
                    	...
                    	sceneController.moveResult(1, kanjiData.getResultScore());
					}
