...
public class MultiModeFrame extends CommonFrame {

    private static final long serialVersionUID = 1L;
    private SceneController sceneController;

    public MultiModeFrame(SceneController sceneController) {
    ...
    protected void initMultiModeUI() {
        ...
        JLabel explainLabel = new JLabel(new ImageIcon("images/explainMulti.png"));
        ...
        startButton.setActionCommand("multi");
        ...
        backButton.setActionCommand("backSelect1");
